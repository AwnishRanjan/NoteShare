    ...
    @objc private func uploadButtonTapped() {
        ...
        present(loadingAlert, animated: true) {
            ...
            FirebaseManager.shared.uploadPDF(
                ...
                DispatchQueue.main.async {
                    // First dismiss the loading alert
                    self?.dismiss(animated: true) {
                        ...
                        case .success:
                            ...
                            successAlert.addAction(UIAlertAction(title: "OK", style: .default) { _ in
                                // Post a notification instead of dismissing again
                                NotificationCenter.default.post(name: NSNotification.Name("PDFUploadedSuccessfully"), object: nil)
